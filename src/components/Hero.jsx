...
const Hero = () => {
  return (
    <>
      <Header />
      <section
        className="text-gray-600 h-[542px] body-font relative w-auto bg-[#1A1A1A] md:overflow-hidden overflow-hidden "
      ...
      >
        <div className="container flex flex-col items-center px-5 mx-auto ">
          <div className="flex flex-col items-center mb-16 text-center lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left md:mb-0">
            ...
            <div className="md:w-[990px] w-[550px] md:h-[310px] h-[280px] z-40 absolute  bg-[#F07E15] bg-opacity-70 md:top-[170px] top-[185px] md:left-[363px]"></div>
            <div className="z-50">
