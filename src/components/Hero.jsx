      ...
      >
        <div className="container flex flex-col items-center px-5 mx-auto ">
          <div className="flex flex-col items-center mb-16 text-center lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left md:mb-0">
            ...
            <div className="md:w-[940px] w-[500px] md:h-[310px] h-[280px] z-40 absolute right-0 bg-[#F07E15] bg-opacity-70 md:top-[170px] top-[185px] md:left-[363px]"></div>
            <div className="z-50">
          ...
          <img
            src={Star4}
            alt="Star4"
            className="absolute md:right-[470px] md:top-[396px] z-50 bottom-[55px]"
          />
